...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    private final Bitmap thumbImage =  MainAllActivity.getImageThumb();
    private final Bitmap thumbPressedImage =  MainAllActivity.getImageThumb();
    private final Bitmap thumbDisabledImage = MainAllActivity.getImageThumb();
    ...
    public static final int DEFAULT_COLOR = Color.parseColor("#f06667");
    ...
    private static final int DEFAULT_TEXT_DISTANCE_TO_BUTTON_IN_DP = -35;
    private static final int DEFAULT_TEXT_DISTANCE_TO_TOP_IN_DP = 22;
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        padding = INITIAL_PADDING + minMaxLabelSize;
       ...
       // boolean selectedValuesAreDefault = (getSelectedMinValue().equals(getAbsoluteMinValue()) &&
        ...
        // draw maximum thumb
        drawThumb(normalizedToScreen(normalizedMaxValue), false, canvas,
                selectedValuesAreDefault);
